...
- [x] #11 Stale processing recovery — deps: #7, #10
- [x] #12 Worker loop + FastAPI lifespan — deps: #9, #11
- [x] #13 /health aggregation — deps: #7, #12
...
- [x] #30 Sender state transitions — deps: #7, #29

## Milestone 10 — Audit + Pruning

- [x] #31 Audit + job error recording (category_code/rationale columns) — deps: #7, #29
...
- [x] #43 Developer README section — deps: #42
