# Claude Code Hooks for cgpt-virtualizer
...
- **`auto-lint.sh`** - Runs type checking (`tsc --noEmit`) after code changes
...
- **`handle-compact.sh`** - Enhances /compact with project-specific context
